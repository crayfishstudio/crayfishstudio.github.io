...
<script>
  ...
  gtag('config', 'UA-146694802-1');
    ...
    <title>Вишуканий | MODERN HOME</title>
    ...
    <main class="main">
        ...
        <section class="planning container-fluid" id="planning">
            ...
            <div class="row no-gutters align-items-center mt-5 pt-lg-4 pt-3">
                <div class="col-lg-4 text-center"><img class="img-fluid" src="./img/house/vishykaniy/house2-plan1.png" data-action="zoom" alt="" srcset=""></div>
                <div class="col-lg-4 text-center pr-lg-4 pr-0 py-5 py-lg-0"><img class="img-fluid" src="./img/house/vishykaniy/house2-plan3.jpg" data-action="zoom" alt="" srcset=""></div>
                <div class="col-lg-4 text-center"><img class="img-fluid" src="./img/house/vishykaniy/house2-plan2.png" data-action="zoom" alt="" srcset=""></div>
            </div>
