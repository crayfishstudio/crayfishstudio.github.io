...
<head>
    ...
    <title>Схід Сонця | MODERN HOME</title>
    ...
    <main class="main">
        ...
        <section class="planning container-fluid" id="planning">
            ...
            <div class="row no-gutters align-items-center mt-5 pt-lg-4 pt-3">
                <div class="col-lg-4 text-center"><img class="img-fluid" src="./img/house/sunrise/house1-plan1.jpg" data-action="zoom" alt="" srcset=""></div>
                <div class="col-lg-4 text-center pr-lg-4 pr-0 py-5 py-lg-0"><img class="img-fluid" src="./img/house/sunrise/house1-plan2.jpg" data-action="zoom" alt="" srcset=""></div>
                <div class="col-lg-4 text-center"><img class="img-fluid" src="./img/house/sunrise/house1-plan3.jpg" data-action="zoom" alt="" srcset=""></div>
            </div>
