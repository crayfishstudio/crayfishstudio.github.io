        ...
        <section class="planning container-fluid" id="planning">
            ...
            <div class="planning__block">
                <div class="planning__imgBlock">
                    <img class="img-fluid" src="./img/house/elit/house3-plan1.jpg" data-action="zoom" alt="" srcset="">
                </div>
                <div class="planning__imgBlock">
                    <img class="img-fluid" src="./img/house/elit/house3-plan2.jpg" data-action="zoom" alt="" srcset="">
                </div>
                <div class="planning__imgBlock">
                    <img class="img-fluid" src="./img/house/elit/house3-plan3.jpg" data-action="zoom" alt="" srcset="">
                </div>
            </div>
